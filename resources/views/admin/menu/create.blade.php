...
@section('content')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden max-w-3xl">
        <div class="p-8">
            <h3 class="text-xl font-bold text-saku-dark mb-2">Formulir Menu</h3>
            <p class="text-sm text-saku-muted mb-6">Lengkapi informasi menu makanan yang akan ditambahkan ke sistem.</p>
            ...
            <form action="{{ route('admin.menu.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" id="vendor_name" name="vendor_name" value="{{ old('vendor_name') }}" placeholder="Contoh: Warung Bu Tini" required
                    ...
                    <div>
                        ...
                        <input type="text" id="menu_name" name="menu_name" value="{{ old('menu_name') }}" placeholder="Contoh: Nasi Goreng Spesial" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" id="price" name="price" value="{{ old('price') }}" placeholder="Contoh: 15000" required
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="3" placeholder="Deskripsi singkat tentang menu ini..."
                        class="w-full px-4 py-3 rounded-xl border {{ $errors->has('description') ? 'border-red-500' : 'border-gray-300' }} focus:border-saku-accent focus:ring-2 focus:ring-saku-accent/20 outline-none transition text-saku-dark bg-gray-50 focus:bg-white">{{ old('description') }}</textarea>
